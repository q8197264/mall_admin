...
export const constantRouterMap = [
  ...
  },
  {
    ...
    meta: { title: 'goodsManage', icon: 'zip', noCache: true },
    children: [{
      path: 'index',
      name: 'index',
      component: () => import('@/views/goods/list'),
      meta: { title: 'goodsList', icon: 'zip', noCache: true }
    }, {
      path: 'add',
      name: 'add',
      component: () => import('@/views/goods/add'),
      meta: { title: 'goodsAdd', icon: 'zip', noCache: true }
    }]
  }, {
    path: '/sales',
    component: Layout,
    redirect: '/sales/index',
    meta: { title: 'sales', icon: 'table', noCache: true },
    children: [{
      name: 'list',
      path: 'list',
      meta: { title: 'salesList', icon: 'table', noCache: true },
      component: () => import('@/views/sales/list')
    }, {
      name: 'dump',
      path: 'dump',
      component: () => import('@/views/sales/dump'),
      meta: { title: 'dump', icon: 'zip', noCache: true }
    }]
  },
  {
    path: '/documentation',
